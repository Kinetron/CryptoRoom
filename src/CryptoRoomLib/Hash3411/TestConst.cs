namespace CryptoRoomLib.Hash3411
{
    ...
    internal static class TestConst
    {
        ...
        ///[1]-А.2 Пример 2
        /// </summary>
        internal static readonly byte[][] TestMessage = new byte[2][];

        static TestConst()
        {
            TestMessage[0] = new byte[]
            {
        ...
        /// [1]-А.2 Пример 2
        /// </summary>
        internal static readonly byte[,] Hash512 = new byte[2, 64]{
            {
        ...
        /// [1]-А.2 Пример 2
        /// </summary>
        internal static readonly byte[,] Hash256 = new byte[2, 32] {
            {
