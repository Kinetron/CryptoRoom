...
namespace CryptoRoomLib.Hash3411
{
    ...
    /// </summary>
    internal static class FastConst
    {
        /// <summary>
        /// Подстановка для функции S.
        /// </summary>
        ...
        /// <summary>
        /// Замещение функции транспозиции (P).
        /// </summary>
        internal static readonly byte[] Tau = new byte[64]{
        ...
        /// </summary>
        internal static readonly ulong[] MatrixMixColumns = new ulong[64]{
        ...
        /// </summary>
        internal static readonly byte[,] KeySchedule = new byte[12, 64]
        {
            {
